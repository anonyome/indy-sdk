...
pub fn u_issuer_create_schema(issuer_did: &str, name: &str, version: &str, attrs: &str) -> Result<(String, String), IndyError>  {

    return issuer_create_schema(issuer_did, name, version, attrs).wait();
}
...
///
pub fn u_issuer_create_and_store_credential_def(wallet_handle: i32, issuer_did: &str, schema_json: &str, 
    tag: &str, signature_type: Option<&str>, config_json: &str) -> Result<(String, String), IndyError> {
    
        return issuer_create_and_store_credential_def(WalletHandle(wallet_handle), issuer_did, schema_json, tag, signature_type, config_json).wait();
}
...
pub fn u_issuer_rotate_credential_def_start(wallet_handle: i32, cred_def_id: &str, config_json: &str) -> Result<String, IndyError> {

    return issuer_rotate_credential_def_start(WalletHandle(wallet_handle), cred_def_id, Some(config_json)).wait();
}
...
///
/// # Returns
pub fn u_issuer_rotate_credential_def_apply(wallet_handle: i32, cred_def_id: &str) -> Result<(), IndyError> {

    return issuer_rotate_credential_def_apply(WalletHandle(wallet_handle), cred_def_id).wait();
}
...
/// }
pub fn u_issuer_create_and_store_revoc_reg(wallet_handle: i32,
    issuer_did: &str,
    revoc_def_type: &str,
    tag: &str,
    cred_def_id: &str,
    ...
    return issuer_create_and_store_revoc_reg(WalletHandle(wallet_handle), issuer_did, 
        Some(revoc_def_type), tag, cred_def_id, config_json, tails_writer_handle).wait();
}
...
///                                   It should not be parsed and are likely to change in future versions).
/// }
pub fn u_issuer_create_credential_offer(wallet_handle: i32, cred_def_id: &str) -> Result<String, IndyError> {

    return issuer_create_credential_offer(WalletHandle(wallet_handle), cred_def_id).wait();
}
...
pub fn u_issuer_create_credential(wallet_handle: i32,
    cred_offer_json: &str,
    cred_req_json: &str,
    cred_values_json: &str,
    rev_reg_id: &str,
    blob_storage_reader_handle: i32) -> Result<(String, Option<String>, Option<String>), IndyError> {

    return issuer_create_credential(WalletHandle(wallet_handle),
        cred_offer_json,
        cred_req_json,
        cred_values_json,
        Some(rev_reg_id),
        blob_storage_reader_handle as BlobStorageReaderHandle).wait();
}
...
pub fn u_issuer_revoke_credential(wallet_handle: i32, blob_storage_reader_cfg_handle: i32, rev_reg_id: &str, 
    cred_revoc_id: &str) -> Result<String, IndyError> {

    return issuer_revoke_credential(WalletHandle(wallet_handle), 
        blob_storage_reader_cfg_handle as BlobStorageReaderCfgHandle, rev_reg_id, cred_revoc_id).wait();
}
...
pub fn u_issuer_merge_revocation_registry_deltas(rev_reg_delta_json: &str, other_rev_reg_delta_json: &str) -> Result<String, IndyError> {

    return issuer_merge_revocation_registry_deltas(rev_reg_delta_json, other_rev_reg_delta_json).wait();
}
...
pub fn u_prover_create_master_secret(wallet_handle: i32, master_secret_id: &str) -> Result<String, IndyError> {

    return prover_create_master_secret(WalletHandle(wallet_handle), Some(master_secret_id)).wait();
}
...
/// }
pub fn u_prover_get_credential(wallet_handle: i32, cred_id: &str) -> Result<String, IndyError> {

    return prover_get_credential(WalletHandle(wallet_handle), cred_id).wait();
}
...
/// * `wallet_handle`: wallet handle (created by Wallet::open_wallet).
/// * `cred_id`: Identifier by which requested credential is stored in the wallet
pub fn u_prover_delete_credential(wallet_handle: i32, cred_id: &str) -> Result<(), IndyError> {

    return prover_delete_credential(WalletHandle(wallet_handle), cred_id).wait();
}
...
pub fn u_prover_create_credential_req(wallet_handle: i32, prover_did: &str, cred_offer_json: &str, 
    cred_def_json: &str, master_secret_id: &str) -> Result<(String, String), IndyError> {
    
    return prover_create_credential_req(WalletHandle(wallet_handle), prover_did, cred_offer_json, 
        cred_def_json, master_secret_id).wait();
}
...
pub fn u_prover_set_credential_attr_tag_policy(wallet_handle: i32, cred_def_id: &str, 
    tag_attrs_json: &str, retroactive: bool) -> Result<(), IndyError> {

    return prover_set_credential_attr_tag_policy(WalletHandle(wallet_handle), cred_def_id, 
        Some(tag_attrs_json), retroactive).wait();
}
...
pub fn u_prover_get_credential_attr_tag_policy(wallet_handle: i32, cred_id: &str) -> Result<String, IndyError> {

    return prover_get_credential_attr_tag_policy(WalletHandle(wallet_handle), cred_id).wait();
}
...
pub fn u_prover_store_credential(wallet_handle: i32, cred_id: &str, cred_req_metadata_json: &str, cred_json: &str, cred_def_json: &str, rev_reg_def_json: &str) -> Result<String, IndyError> {

    return prover_store_credential(WalletHandle(wallet_handle), Some(cred_id), cred_req_metadata_json, cred_json, cred_def_json, Some(rev_reg_def_json)).wait();
}
...
///     "cred_rev_id": Optional<string>
/// }]
pub fn u_prover_get_credentials(wallet_handle: i32, filter_json: &str) -> Result<String, IndyError> {

    return prover_get_credentials(WalletHandle(wallet_handle), Some(filter_json)).wait();
}
...
pub fn u_prover_search_credentials(wallet_handle: i32, query_json: &str) -> Result<(SearchHandle, usize), IndyError> {

    return prover_search_credentials(WalletHandle(wallet_handle), Some(query_json)).wait();
}
...
///     "cred_rev_id": Optional<string>
///  }]
pub fn u_prover_fetch_credentials(search_handle: i32, count: usize) -> Result<String, IndyError> {

    return prover_fetch_credentials(search_handle as SearchHandle, count).wait();
}
...
/// # Arguments
/// * `search_handle`: Search handle (created by search_credentials)
pub fn u_prover_close_credentials_search(search_handle: i32) -> Result<(), IndyError> {

    return prover_close_credentials_search(search_handle as SearchHandle).wait();
}
...
///     }
pub fn u_prover_get_credentials_for_proof_req(wallet_handle: i32, proof_request_json: &str) -> Result<String, IndyError> {

    return prover_get_credentials_for_proof_req(WalletHandle(wallet_handle), proof_request_json).wait();
}
...
pub fn u_prover_search_credentials_for_proof_req(wallet_handle: i32,
    proof_request_json: &str,
    extra_query_json: &str) -> Result<CommandHandle, IndyError> {

    return prover_search_credentials_for_proof_req(WalletHandle(wallet_handle),
        proof_request_json, Some(extra_query_json)).wait();
}
...
pub fn u_prover_fetch_credentials_for_proof_req(search_handle: i32, item_referent: &str, count: usize) -> Result<String, IndyError> {

    return prover_fetch_credentials_for_proof_req(search_handle as SearchHandle, item_referent, count).wait()
}
...
/// # Arguments
/// * `search_handle`: Search handle (created by search_credentials_for_proof_req)
pub fn u_prover_close_credentials_search_for_proof_req(search_handle: i32) -> Result<(), IndyError> {

    return prover_close_credentials_search_for_proof_req(search_handle as SearchHandle).wait();
}
...
///     }
pub fn u_prover_create_proof(wallet_handle: i32, proof_req_json: &str, requested_credentials_json: &str, master_secret_id: &str, schemas_json: &str, credential_defs_json: &str, rev_states_json: &str) -> Result<String, IndyError> {

    return prover_create_proof(WalletHandle(wallet_handle), proof_req_json, requested_credentials_json, master_secret_id, schemas_json, credential_defs_json, rev_states_json).wait();
}
...
pub fn u_verifier_verify_proof(proof_request_json: &str, proof_json: &str, schemas_json: &str, credential_defs_json: &str, rev_reg_defs_json: &str, rev_regs_json: &str) -> Result<bool, IndyError> {

    return verifier_verify_proof(proof_request_json, proof_json, schemas_json, credential_defs_json, rev_reg_defs_json, rev_regs_json).wait();
}
...
///     "timestamp" : integer
/// }
pub fn u_create_revocation_state(blob_storage_reader_handle: i32, rev_reg_def_json: &str, rev_reg_delta_json: &str, timestamp: u64, cred_rev_id: &str) -> Result<String, IndyError> {

    return create_revocation_state(blob_storage_reader_handle as BlobStorageReaderHandle, rev_reg_def_json, 
        rev_reg_delta_json, timestamp, cred_rev_id).wait();
}
...
///     "timestamp" : integer
/// }
pub fn u_update_revocation_state(blob_storage_reader_handle: BlobStorageReaderHandle, rev_state_json: &str, rev_reg_def_json: &str, rev_reg_delta_json: &str, timestamp: u64, cred_rev_id: &str) -> Result<String, IndyError> {

    return update_revocation_state(blob_storage_reader_handle as BlobStorageReaderHandle, rev_state_json, 
        rev_reg_def_json, rev_reg_delta_json, timestamp, cred_rev_id).wait();
}
...
pub fn u_generate_nonce() -> Result<String, IndyError> {

    return generate_nonce().wait();
}
...
pub fn u_to_unqualified(entity: &str) -> Result<String, IndyError> {

    return to_unqualified(entity).wait();
}
