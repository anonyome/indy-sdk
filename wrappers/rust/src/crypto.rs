...
pub fn u_create_key(wallet_handle: WalletHandle, my_key_json: Option<&str>) -> Result<String, IndyError> {

    return create_key(wallet_handle, my_key_json).wait();
}
...
pub fn u_set_key_metadata(wallet_handle: WalletHandle, verkey: &str, metadata: &str) -> Result<(), IndyError> {

    return set_key_metadata(wallet_handle, verkey, metadata).wait();
}
...
pub fn u_get_key_metadata(wallet_handle: WalletHandle, verkey: &str) -> Result<String, IndyError> {

    return get_key_metadata(wallet_handle, verkey).wait();
}
...
/// # Returns
/// the signature
pub fn u_sign(wallet_handle: WalletHandle, signer_vk: &str, message: &[u8]) -> Result<Vec<u8>, IndyError> {

    return sign(wallet_handle, signer_vk, message).wait();
}
...
pub fn u_verify(signer_vk: &str, message: &[u8], signature: &[u8]) -> Result<bool, IndyError> {

    return verify(signer_vk, message, signature).wait();
}
...
pub fn u_auth_crypt(wallet_handle: WalletHandle, sender_vk: &str, recipient_vk: &str, message: &[u8]) -> Result<Vec<u8>, IndyError> {

    return auth_crypt(wallet_handle, sender_vk, recipient_vk, message).wait();
}
...
pub fn u_auth_decrypt(wallet_handle: WalletHandle, recipient_vk: &str, encrypted_message: &[u8]) -> Result<(String, Vec<u8>), IndyError> {
    
    return auth_decrypt(wallet_handle, recipient_vk, encrypted_message).wait()
}
...
/// # Returns
/// the encrypted message
pub fn u_anon_crypt(recipient_vk: &str, message: &[u8]) -> Result<Vec<u8>, IndyError> {

    return anon_crypt(recipient_vk, message).wait();
}
...
/// # Returns
/// decrypted message
pub fn u_anon_decrypt(wallet_handle: WalletHandle, recipient_vk: &str, encrypted_message: &[u8]) -> Result<Vec<u8>, IndyError> {

    return anon_decrypt(wallet_handle, recipient_vk, encrypted_message).wait();
}
...
pub fn u_pack_message(wallet_handle: WalletHandle, message: &[u8], receiver_keys: &str, sender: &str) -> Result<Vec<u8>, IndyError> {

    return pack_message(wallet_handle, message, receiver_keys, Some(sender)).wait();
}
...
pub fn u_unpack_message(wallet_handle: WalletHandle, jwe: &[u8]) -> Result<Vec<u8>, IndyError> {

    return unpack_message(wallet_handle, jwe).wait();
}
